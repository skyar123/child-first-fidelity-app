...
import { ArrowLeft, Menu, Download, X, FileText, ClipboardList, Calendar, Users, Brain, Heart, Link2, Shield, CheckSquare, Target, Plus, Trash2, Compass, PenLine, MessageSquare, Sparkles } from 'lucide-react'
