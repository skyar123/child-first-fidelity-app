...
export function FidelityStrandsSection() {
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-4xl mx-auto">
      {/* Intro + rating legend. The section progress lives in the header card above. */}
      <div className="glass-card rounded-2xl p-4 space-y-3 text-sm text-gray-600">
        <p>
          Each strand has two parts: <strong>Potential Sources of Challenge</strong> (rated on a
          4-point scale) and <strong>Clinician/Care Coordinator Capacity</strong> (rated on a
          3-point scale).
        </p>
